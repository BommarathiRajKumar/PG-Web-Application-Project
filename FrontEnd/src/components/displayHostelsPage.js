    ...
    return(
        ...
        <div style={style} className={displayHostelsPage.mainDiv}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                ...
                <button style={{marginLeft:'5px',marginRight:'5px'}} className={displayHostelsPage.changeImagesButtons} onClick={imageTwoHadler}>2 </button>
                ...
                <table className={displayHostelsPage.table}>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className={displayHostelsPage.td} colSpan="2">{data.wifi==="Yes"?<label style={{color:'green',marginLeft:'30px'}}>Available</label>:<label style={{color:'red',marginLeft:'30px'}}>Not-Available</label>}</td>
                        </tr>
                        <tr>
                            <th className={displayHostelsPage.th1}>Laundry:</th>
                            <td className={displayHostelsPage.td} colSpan="2">{data.laundry==="Yes"?<label style={{color:'green',marginLeft:'30px'}}>Available</label>:<label style={{color:'red',marginLeft:'30px'}}>Not-Available</label>}</td>
                        </tr>
                        <tr>
                            <th className={displayHostelsPage.th1}>Hot Water:</th>
                            <td className={displayHostelsPage.td} colSpan="2">{data.hotWater==="Yes"?<label style={{color:'green',marginLeft:'30px'}}>Available</label>:<label style={{color:'red',marginLeft:'30px'}}>Not-Available</label>}</td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
